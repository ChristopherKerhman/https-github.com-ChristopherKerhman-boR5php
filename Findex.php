...
<section>
  ...
  <div id="RS">
    ...
    <article v-if="cle">
      <h4 >{{titreRS}}</h4>
        <p  class="justify largeur1" v-if="RStext != ''">{{RStext}}</p>
    </article>
  ...
  <article>
    <h4 v-if="!cle2" v-on:click="cle2 = true" class="lienNav">Les sortes génériques</h4><h4 v-else v-on:click="cle2 = false" class="lienNav">Les sortes génériques<i class="far fa-window-close"></i></h4>
    <div v-if="cle2" class="conteneur_col">
      <div class="justify largeur1" v-if="titreSort != ''">
